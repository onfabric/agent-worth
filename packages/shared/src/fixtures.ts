  ...
  createTranscriptCloudEvent({
    ...
    payload: {
      ...
      raw: [
        ...
        {
          type: 'response_item',
          payload: { role: 'user', content: 'Write tests for the billing parser.' },
        },
        {
          type: 'response_item',
          payload: { role: 'assistant', content: 'Added parser fixture tests.' },
        },
      ],
      messages: [
        {
      ...
      raw: [
        {
          ...
          message: { content: 'Refactor the sync job lock.' },
        },
        {
          type: 'assistant',
          sessionId: 'claude_synthetic_001',
